...
tags:
  ...
  - 面试
  - 集合
keywords: Java集合框架常见面试题
abbrlink: 330a9fa
date: 2020-01-10 09:45:56
---
# 剖析面试最常见问题之Java集合框架
...
![双向链表](../../../images/java/collection/面试/双向链表.png)

**双向循环链表：** 最后一个节点的 next 指向head，而 head 的prev指向最后一个节点，构成一个环。

![双向循环链表](../../../images/java/collection/面试/双向循环链表.png)
...
![jdk1.8之前的内部结构-HashMap](../../../images/java/collection/面试/jdk1.8之前的内部结构-HashMap.jpg)

### JDK1.8之后

相比于之前的版本， JDK1.8之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为8）时，将链表转化为红黑树，以减少搜索时间。

![jdk1.8之后的内部结构-HashMap](../../../images/java/collection/面试/JDK1.8之后的HashMap底层数据结构.jpg)
...
![HashTable全表锁](../../../images/java/collection/面试/HashTable全表锁.png)

**JDK1.7的ConcurrentHashMap：**

![JDK1.7的ConcurrentHashMap](../../../images/java/collection/面试/ConcurrentHashMap分段锁.jpg)

**JDK1.8的ConcurrentHashMap（TreeBin: 红黑二叉树节点 Node: 链表节点）：**

![JDK1.8的ConcurrentHashMap](../../../images/java/collection/面试/JDK1.8-ConcurrentHashMap-Structure.jpg)
