...
![查看MySQL提供的所有存储引擎](../../images/database/mysql/mysql-engines.png)
...
![查看表的存储引擎](../../images/database/mysql/查看表的存储引擎.png)
...
![事物的特性](../../images/database/mysql/事务特性.png)
 ...
 **简单来说垂直拆分是指数据表列的拆分，把一张列比较多的表拆分为多张表。** 如下图所示，这样来说大家应该就更容易理解了。
 ![数据库垂直分区](../../images/database/mysql/数据库垂直分区.png)
...
![数据库水平拆分](../../images/database/mysql/数据库水平拆分.png)
